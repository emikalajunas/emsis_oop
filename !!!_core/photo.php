...
require_once ("admin/includes/init.php"); //includes classes
...
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <!-- Author -->
                <p class="lead">
                    by <a href="#">Custom photo page (id nr: <?php echo $photo->id?></a>
                </p>
                ...
                <?php //starting loop through comments to get comments database data
