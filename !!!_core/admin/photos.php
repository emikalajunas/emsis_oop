...
$photos = User::find_by_id($_SESSION['user_id'])->photos();// calling stating method
//$photos = Photo::find_all();// calling stating method
...
<!-- Class delete link is for jquery confirmation-->                                         
                                           <a class="delete_link" href="delete_photo.php?id=<?php echo $photo->id; ?>">Delete</a> 
<!-- Class delete link is for jquery confirmation-->
                                           <a href="edit_photo.php?id=<?php echo $photo->id; ?>">Edit</a>
                                           <a href="edit_photo.php?id=<?php echo $photo->id; ?>">View</a>
